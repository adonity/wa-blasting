                ...
                <div class="dropdown">
                        ...
                        <div class="user-menu d-flex">
                            ...
                            <div class="user-img d-flex align-items-center">
                                <div class="avatar avatar-md">
                                    <img src="{{ Auth::user()->profile_photo_path?asset("storage/".Auth::user()->profile_photo_path):asset('/images/faces/1.png') }}">
                                </div>
                            </div>
                        </div>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                        ...
                        @if (Laravel\Jetstream\Jetstream::hasApiFeatures())
                            <li>
                                <a class="dropdown-item" href="{{ route('api-tokens.index')}}"><i class="icon-mid bi bi-gear me-2"></i>
                                {{ __('API Tokens') }}
                                </a>
                            </li>
                        @endif
