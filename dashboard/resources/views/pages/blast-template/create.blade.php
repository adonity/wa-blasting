    ...
    <x-slot name="header">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-first">
                <h3>{{ __("Tambah Broadcast Template") }}</h3>
                <p class="text-subtitle text-muted">{{ __("Tambah Broadcast Template") }}</p>
            </div>
            ...
            <div class="col-12 col-md-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ route('blast-template.store') }}" method="post" class="form form-horizontal" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="form-group col-md-8 offset-md-4 d-none">
