    ...
    <x-slot name="header">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-first">
                <h3>Devices</h3>
                <p class="text-subtitle text-muted">Sync Whatsapp</p>
            </div>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        @if ($device->qrcode)
                                            <h1 class="text-center" style="width:300px">{{strtoupper($device->name)}}</h1>
                                            <img src="{{$device->qrcode}}" class="" style="width:300px" alt="">
                                        @elseif ($device->status == "disconnected")
                                            <p class="h1 text-warning">Wait...</p>
                                        @else
                                            <p class="h1 text-success">Connected</p>
                                            <script type="text/javascript">
                                                setTimeout("location.href = '/devices/scan/{{$device->id+1}}';",2000);
                                           </script>
                                        @endif
                                    </div>
                                </div>
