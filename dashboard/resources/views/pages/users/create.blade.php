                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group has-icon-left">
                                                <div class="position-relative">
                                                    <input type="text" name="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" placeholder="Nama">
                                        ...
                                        @else
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            <select name="role" class="form-select {{ $errors->has('role') ? 'is-invalid' : '' }}" {{$user->role == 2?"disabled":""}}>
                                                                <option value="2">Super Admin</option>
                                                                <option value="3" {{$user->role == 2?"selected":""}}>Team</option>
                                                            </select>
                                            ...
                                            <div class="container-fluid super-admin d-none">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            <select name="parent" class="form-select {{ $errors->has('parent') ? 'is-invalid' : '' }}" {{$user->role == 2?"disabled":""}}>
                                                                @foreach ($users as $item)
                                                                    <option value="{{$item->id}}" {{$user->role == 2 && $item->id == $user->id?"selected":""}}>{{$item->name}}</option>
                                                                @endforeach
                                                            </select>
